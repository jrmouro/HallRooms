...
public class ListExperimentTest {
    ...
    //List<IAllocatorN2> listAllocator = new ArrayList();
    ...
    public void setUp() {
       ...
       /* this.listAllocator.add(new NaiveAllocatorN2());
        this.listAllocator.add(new HungarianAllocatorN2());
        this.listAllocator.add(new LocalSearchAllocatorN2());*/
